class LegaciesController < ApplicationController
  ...
  private
    ...
    def legacy_params
      params.require(:legacy).permit(:one_line_grab, :description_project_sheet, :description_awards_style, :innovation_client_style, :interesting_things, :brief_elements, :security_level)
    end
end
