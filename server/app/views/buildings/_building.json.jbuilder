json.id building.id
json.extract! building, :created_at, :updated_at, :description, :attribution, :BCA_classification, :project_categories, :project_sub_catagories, :source_information_filepath, :planning_authority, :legacy_bd_number, :confidential
json.locations do
