...
describe CampaignsController do
  ...
  let(:valid_attributes) { { "strategy" => "MyText" } }
  ...
  describe "GET show" do
    it "assigns the requested config_project as @config_project" do
      ...
      assigns(:config_project).should eq(campaign)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new config_project as @config_project" do
      ...
      assigns(:config_project).should be_a_new(Campaign)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created config_project as @config_project" do
        post :create, {:config_project => valid_attributes}, valid_session
        assigns(:config_project).should be_a(Campaign)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved config_project as @config_project" do
        ...
        post :create, {:config_project => { "strategy" => "invalid value" }}, valid_session
        assigns(:config_project).should be_a_new(Campaign)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested config_project" do
        ...
        Campaign.any_instance.should_receive(:update).with({ "strategy" => "MyText" })
        put :update, {:id => campaign.to_param, :config_project => { "strategy" => "MyText" }}, valid_session
      end

      it "assigns the requested config_project as @config_project" do
        campaign = Campaign.create! valid_attributes
        put :update, {:id => campaign.to_param, :config_project => valid_attributes}, valid_session
        assigns(:config_project).should eq(campaign)
      end
    ...
    describe "with invalid params" do
      it "assigns the config_project as @config_project" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Campaign.any_instance.stub(:save).and_return(false)
        put :update, {:id => campaign.to_param, :config_project => { "strategy" => "invalid value" }}, valid_session
        assigns(:config_project).should eq(campaign)
      end
