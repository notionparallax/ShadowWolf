...
describe InitiativesController do
  ...
  describe "GET show" do
    it "assigns the requested config_project as @config_project" do
      ...
      assigns(:config_project).should eq(initiative)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new config_project as @config_project" do
      ...
      assigns(:config_project).should be_a_new(Initiative)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created config_project as @config_project" do
        post :create, {:config_project => valid_attributes}, valid_session
        assigns(:config_project).should be_a(Initiative)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved config_project as @config_project" do
        ...
        post :create, {:config_project => { "title" => "invalid value" }}, valid_session
        assigns(:config_project).should be_a_new(Initiative)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested config_project" do
        ...
        Initiative.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => initiative.to_param, :config_project => { "title" => "MyString" }}, valid_session
      end

      it "assigns the requested config_project as @config_project" do
        initiative = Initiative.create! valid_attributes
        put :update, {:id => initiative.to_param, :config_project => valid_attributes}, valid_session
        assigns(:config_project).should eq(initiative)
      end
    ...
    describe "with invalid params" do
      it "assigns the config_project as @config_project" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Initiative.any_instance.stub(:save).and_return(false)
        put :update, {:id => initiative.to_param, :config_project => { "title" => "invalid value" }}, valid_session
        assigns(:config_project).should eq(initiative)
      end
