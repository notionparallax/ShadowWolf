...
describe AttentionsController do
  ...
  # AttentionsController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all attentions as @attentions" do
      attention = Attention.create! valid_attributes
      get :index, {}, valid_session
      assigns(:attentions).should eq([attention])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested config_person as @config_person" do
      ...
      assigns(:config_person).should eq(attention)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new config_person as @config_person" do
      ...
      assigns(:config_person).should be_a_new(Attention)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created config_person as @config_person" do
        post :create, {:config_person => valid_attributes}, valid_session
        assigns(:config_person).should be_a(Attention)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested config_person" do
        ...
        Attention.any_instance.should_receive(:update).with({ "date" => "2014-03-04" })
        put :update, {:id => attention.to_param, :config_person => { "date" => "2014-03-04" }}, valid_session
      end

      it "assigns the requested config_person as @config_person" do
        attention = Attention.create! valid_attributes
        put :update, {:id => attention.to_param, :config_person => valid_attributes}, valid_session
        assigns(:config_person).should eq(attention)
      end
    ...
    describe "with invalid params" do
      it "assigns the config_person as @config_person" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Attention.any_instance.stub(:save).and_return(false)
        put :update, {:id => attention.to_param, :config_person => { "date" => "invalid value" }}, valid_session
        assigns(:config_person).should eq(attention)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the attentions list" do
      attention = Attention.create! valid_attributes
      delete :destroy, {:id => attention.to_param}, valid_session
      response.should redirect_to(attentions_url)
    end
  end
