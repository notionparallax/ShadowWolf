...
describe QuotesController do
  ...
  describe "GET show" do
    it "assigns the requested config_project as @config_project" do
      ...
      assigns(:config_project).should eq(quote)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new config_project as @config_project" do
      ...
      assigns(:config_project).should be_a_new(Quote)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created config_project as @config_project" do
        post :create, {:config_project => valid_attributes}, valid_session
        assigns(:config_project).should be_a(Quote)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved config_project as @config_project" do
        ...
        post :create, {:config_project => { "quote" => "invalid value" }}, valid_session
        assigns(:config_project).should be_a_new(Quote)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested config_project" do
        ...
        put :update, {:id => quote.to_param, :config_project => { "quote" => "MyText" }}, valid_session
      end

      it "assigns the requested config_project as @config_project" do
        quote = Quote.create! valid_attributes
        put :update, {:id => quote.to_param, :config_project => valid_attributes}, valid_session
        assigns(:config_project).should eq(quote)
      end
    ...
    describe "with invalid params" do
      it "assigns the config_project as @config_project" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Quote.any_instance.stub(:save).and_return(false)
        put :update, {:id => quote.to_param, :config_project => { "quote" => "invalid value" }}, valid_session
        assigns(:config_project).should eq(quote)
      end
