...
describe PeopleController do
  ...
  describe "GET show" do
    it "assigns the requested config_model as @config_model" do
      ...
      assigns(:config_model).should eq(person)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new config_model as @config_model" do
      ...
      assigns(:config_model).should be_a_new(Person)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created config_model as @config_model" do
        post :create, {:config_model => valid_attributes}, valid_session
        assigns(:config_model).should be_a(Person)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested config_model" do
        ...
        put :update, {:id => person.to_param, :config_model => { "these" => "params" }}, valid_session
      end

      it "assigns the requested config_model as @config_model" do
        person = Person.create! valid_attributes
        put :update, {:id => person.to_param, :config_model => valid_attributes}, valid_session
        assigns(:config_model).should eq(person)
      end
    ...
    describe "with invalid params" do
      it "assigns the config_model as @config_model" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Person.any_instance.stub(:save).and_return(false)
        put :update, {:id => person.to_param, :config_model => {  }}, valid_session
        assigns(:config_model).should eq(person)
      end
