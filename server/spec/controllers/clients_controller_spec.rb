...
describe ClientsController do
  ...
  describe "GET show" do
    it "assigns the requested config_project as @config_project" do
      ...
      assigns(:config_project).should eq(client)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new config_project as @config_project" do
      ...
      assigns(:config_project).should be_a_new(Client)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created config_project as @config_project" do
        post :create, {:config_project => valid_attributes}, valid_session
        assigns(:config_project).should be_a(Client)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved config_project as @config_project" do
        ...
        post :create, {:config_project => { "main" => "invalid value" }}, valid_session
        assigns(:config_project).should be_a_new(Client)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested config_project" do
        ...
        Client.any_instance.should_receive(:update).with({ "main" => "MyString" })
        put :update, {:id => client.to_param, :config_project => { "main" => "MyString" }}, valid_session
      end

      it "assigns the requested config_project as @config_project" do
        client = Client.create! valid_attributes
        put :update, {:id => client.to_param, :config_project => valid_attributes}, valid_session
        assigns(:config_project).should eq(client)
      end
    ...
    describe "with invalid params" do
      it "assigns the config_project as @config_project" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Client.any_instance.stub(:save).and_return(false)
        put :update, {:id => client.to_param, :config_project => { "main" => "invalid value" }}, valid_session
        assigns(:config_project).should eq(client)
      end
