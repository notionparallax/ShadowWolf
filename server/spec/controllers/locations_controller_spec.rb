...
describe LocationsController do
  ...
  describe "GET show" do
    it "assigns the requested config_project as @config_project" do
      ...
      assigns(:config_project).should eq(location)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new config_project as @config_project" do
      ...
      assigns(:config_project).should be_a_new(Location)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created config_project as @config_project" do
        post :create, {:config_project => valid_attributes}, valid_session
        assigns(:config_project).should be_a(Location)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested config_project" do
        ...
        put :update, {:id => location.to_param, :config_project => { "these" => "params" }}, valid_session
      end

      it "assigns the requested config_project as @config_project" do
        location = Location.create! valid_attributes
        put :update, {:id => location.to_param, :config_project => valid_attributes}, valid_session
        assigns(:config_project).should eq(location)
      end
    ...
    describe "with invalid params" do
      it "assigns the config_project as @config_project" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Location.any_instance.stub(:save).and_return(false)
        put :update, {:id => location.to_param, :config_project => {  }}, valid_session
        assigns(:config_project).should eq(location)
      end
