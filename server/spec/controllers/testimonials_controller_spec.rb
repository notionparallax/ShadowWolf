...
describe TestimonialsController do
  ...
  let(:valid_attributes) { { "testimonial" => "MyText" } }
  ...
  describe "GET show" do
    it "assigns the requested config_project as @config_project" do
      ...
      assigns(:config_project).should eq(testimonial)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new config_project as @config_project" do
      ...
      assigns(:config_project).should be_a_new(Testimonial)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created config_project as @config_project" do
        post :create, {:config_project => valid_attributes}, valid_session
        assigns(:config_project).should be_a(Testimonial)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved config_project as @config_project" do
        ...
        post :create, {:config_project => { "testimonial" => "invalid value" }}, valid_session
        assigns(:config_project).should be_a_new(Testimonial)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested config_project" do
        ...
        Testimonial.any_instance.should_receive(:update).with({ "testimonial" => "MyText" })
        put :update, {:id => testimonial.to_param, :config_project => { "testimonial" => "MyText" }}, valid_session
      end

      it "assigns the requested config_project as @config_project" do
        testimonial = Testimonial.create! valid_attributes
        put :update, {:id => testimonial.to_param, :config_project => valid_attributes}, valid_session
        assigns(:config_project).should eq(testimonial)
      end
    ...
    describe "with invalid params" do
      it "assigns the config_project as @config_project" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Testimonial.any_instance.stub(:save).and_return(false)
        put :update, {:id => testimonial.to_param, :config_project => { "testimonial" => "invalid value" }}, valid_session
        assigns(:config_project).should eq(testimonial)
      end
