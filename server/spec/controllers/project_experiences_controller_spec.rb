...
describe ProjectExperiencesController do
  ...
  let(:valid_attributes) { { "start_date" => "2014-03-04" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested config_person" do
        ...
        ProjectExperience.any_instance.should_receive(:update).with({ "start_date" => "2014-03-04" })
        put :update, {:id => project_experience.to_param, :config_person => { "start_date" => "2014-03-04" }}, valid_session
      end
