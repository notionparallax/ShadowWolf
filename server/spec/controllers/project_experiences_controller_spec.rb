...
describe ProjectExperiencesController do
  ...
  let(:valid_attributes) { { "start_date" => "2014-08-06" } }
  ...
  describe "GET show" do
    it "assigns the requested config_person as @config_person" do
      ...
      assigns(:config_person).should eq(project_experience)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new config_person as @config_person" do
      ...
      assigns(:config_person).should be_a_new(ProjectExperience)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created config_person as @config_person" do
        post :create, {:config_person => valid_attributes}, valid_session
        assigns(:config_person).should be_a(ProjectExperience)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved config_person as @config_person" do
        ...
        post :create, {:config_person => { "start_date" => "invalid value" }}, valid_session
        assigns(:config_person).should be_a_new(ProjectExperience)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested config_person" do
        ...
        ProjectExperience.any_instance.should_receive(:update).with({ "start_date" => "2014-08-06" })
        put :update, {:id => project_experience.to_param, :config_person => { "start_date" => "2014-08-06" }}, valid_session
      end

      it "assigns the requested config_person as @config_person" do
        project_experience = ProjectExperience.create! valid_attributes
        put :update, {:id => project_experience.to_param, :config_person => valid_attributes}, valid_session
        assigns(:config_person).should eq(project_experience)
      end
    ...
    describe "with invalid params" do
      it "assigns the config_person as @config_person" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ProjectExperience.any_instance.stub(:save).and_return(false)
        put :update, {:id => project_experience.to_param, :config_person => { "start_date" => "invalid value" }}, valid_session
        assigns(:config_person).should eq(project_experience)
      end
