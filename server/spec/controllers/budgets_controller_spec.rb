...
describe BudgetsController do
  ...
  describe "GET show" do
    it "assigns the requested config_project as @config_project" do
      ...
      assigns(:config_project).should eq(budget)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new config_project as @config_project" do
      ...
      assigns(:config_project).should be_a_new(Budget)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created config_project as @config_project" do
        post :create, {:config_project => valid_attributes}, valid_session
        assigns(:config_project).should be_a(Budget)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved config_project as @config_project" do
        ...
        post :create, {:config_project => { "initial_phase_value_total" => "invalid value" }}, valid_session
        assigns(:config_project).should be_a_new(Budget)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "assigns the requested config_project as @config_project" do
        budget = Budget.create! valid_attributes
        put :update, {:id => budget.to_param, :config_project => valid_attributes}, valid_session
        assigns(:config_project).should eq(budget)
      end
    ...
    describe "with invalid params" do
      it "assigns the config_project as @config_project" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Budget.any_instance.stub(:save).and_return(false)
        put :update, {:id => budget.to_param, :config_project => { "initial_phase_value_total" => "invalid value" }}, valid_session
        assigns(:config_project).should eq(budget)
      end
