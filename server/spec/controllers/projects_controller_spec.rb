...
describe ProjectsController do
  ...
  describe "GET show" do
    it "assigns the requested config_project as @config_project" do
      ...
      assigns(:config_project).should eq(project)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new config_project as @config_project" do
      ...
      assigns(:config_project).should be_a_new(Project)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created config_project as @config_project" do
        post :create, {:config_project => valid_attributes}, valid_session
        assigns(:config_project).should be_a(Project)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved config_project as @config_project" do
        ...
        post :create, {:config_project => { "project_number" => "invalid value" }}, valid_session
        assigns(:config_project).should be_a_new(Project)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested config_project" do
        ...
        put :update, {:id => project.to_param, :config_project => { "project_number" => "MyString" }}, valid_session
      end

      it "assigns the requested config_project as @config_project" do
        project = Project.create! valid_attributes
        put :update, {:id => project.to_param, :config_project => valid_attributes}, valid_session
        assigns(:config_project).should eq(project)
      end
    ...
    describe "with invalid params" do
      it "assigns the config_project as @config_project" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Project.any_instance.stub(:save).and_return(false)
        put :update, {:id => project.to_param, :config_project => { "project_number" => "invalid value" }}, valid_session
        assigns(:config_project).should eq(project)
      end
