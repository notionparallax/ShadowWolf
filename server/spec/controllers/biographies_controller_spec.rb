...
describe BiographiesController do
  ...
  describe "GET show" do
    it "assigns the requested config_model as @config_model" do
      ...
      assigns(:config_model).should eq(biography)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new config_model as @config_model" do
      ...
      assigns(:config_model).should be_a_new(Biography)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created config_model as @config_model" do
        post :create, {:config_model => valid_attributes}, valid_session
        assigns(:config_model).should be_a(Biography)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved config_model as @config_model" do
        ...
        post :create, {:config_model => { "one_line_bio" => "invalid value" }}, valid_session
        assigns(:config_model).should be_a_new(Biography)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested config_model" do
        ...
        put :update, {:id => biography.to_param, :config_model => { "one_line_bio" => "MyString" }}, valid_session
      end

      it "assigns the requested config_model as @config_model" do
        biography = Biography.create! valid_attributes
        put :update, {:id => biography.to_param, :config_model => valid_attributes}, valid_session
        assigns(:config_model).should eq(biography)
      end
    ...
    describe "with invalid params" do
      it "assigns the config_model as @config_model" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Biography.any_instance.stub(:save).and_return(false)
        put :update, {:id => biography.to_param, :config_model => { "one_line_bio" => "invalid value" }}, valid_session
        assigns(:config_model).should eq(biography)
      end
