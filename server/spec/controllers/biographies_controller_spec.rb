...
describe BiographiesController do
  ...
  let(:valid_attributes) { { "one_line_bio" => "MyString" } }
  ...
  describe "GET show" do
    it "assigns the requested config_person as @config_person" do
      ...
      assigns(:config_person).should eq(biography)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new config_person as @config_person" do
      ...
      assigns(:config_person).should be_a_new(Biography)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created config_person as @config_person" do
        post :create, {:config_person => valid_attributes}, valid_session
        assigns(:config_person).should be_a(Biography)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved config_person as @config_person" do
        ...
        post :create, {:config_person => { "one_line_bio" => "invalid value" }}, valid_session
        assigns(:config_person).should be_a_new(Biography)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested config_person" do
        ...
        Biography.any_instance.should_receive(:update).with({ "one_line_bio" => "MyString" })
        put :update, {:id => biography.to_param, :config_person => { "one_line_bio" => "MyString" }}, valid_session
      end

      it "assigns the requested config_person as @config_person" do
        biography = Biography.create! valid_attributes
        put :update, {:id => biography.to_param, :config_person => valid_attributes}, valid_session
        assigns(:config_person).should eq(biography)
      end
    ...
    describe "with invalid params" do
      it "assigns the config_person as @config_person" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Biography.any_instance.stub(:save).and_return(false)
        put :update, {:id => biography.to_param, :config_person => { "one_line_bio" => "invalid value" }}, valid_session
        assigns(:config_person).should eq(biography)
      end
